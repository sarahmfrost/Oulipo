...
for (i = 0; i < lines.length; i++){
  ...
  // full_poem.push('<span>'+lines[i][ranNum]+'</span>');
  full_poem += lines[i][ranNum]+'<br>';
  full_poem_fr += lines_fr[i][ranNum]+'<br>';
  };

    document.getElementById('poemDisplay').innerHTML = '<div class="poem">'+full_poem_fr+'</div><div class="poem">' + full_poem+'</div>';
